    ...
    <footer className="relative w-full bg-gray-100 mt-36 font-poppins">
      <div className="mx-auto w-full max-w-7xl px-8 ">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
          ...
          <Typography variant="h5" className="mb-6 mt-5 text-customGreen font-poppins">
            Bali Pure Tour<br/> <span className='text-customGreenslow font-poppins text-xs'>Serving you in the best traveling experience</span>
          </Typography>
          ...
          <div className="grid grid-cols-3 justify-between gap-4 mt-5 text-white">
            {LINKS.map(({ title, items }) => (
              <ul key={title}>
                <Typography
                  variant="small"
                  className="mb-3 font-poppins text-customGreen font-semibold"
                >
                  {title}
                </Typography>
                {items.map((link) => (
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-200 py-4 md:flex-row md:justify-between">
          <Typography
            variant="small"
            className="mb-4 text-center  text-customGreen font-medium font-poppins md:mb-0"
          >
            &copy; {currentYear} <a href="https://material-tailwind.com/">Traveling Kuy</a>. All
            Rights Reserved.
          </Typography>
